...
nnoremap yim mq/{<cr>vi{y`q:noh<cr>
nnoremap yam mq/{<cr>va{y`q:noh<cr>
nnoremap yum mq/{<cr>va{Vy`q:noh<cr>
nnoremap dim mq/{<cr>vi{d`q:noh<cr>
nnoremap dam mq/{<cr>va{d`q:noh<cr>
nnoremap dum mq/{<cr>va{Vd`q:noh<cr>
